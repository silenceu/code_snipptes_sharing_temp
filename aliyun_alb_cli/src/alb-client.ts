...
export default class AlbClient extends AlbBaseClient {
    ...
    async getServerGroupServers(
        ...
        const serverGroupServersResponse: ListServerGroupServersResponse =
            await this.listServerGroupServers(serverGroupServersRequest);
    ...
    async setServerWeight(
        ...
        const updateServer =
            new UpdateServerGroupServersAttributeRequestServers({
        ...
        const updateServerGroupServersAttributeRequest =
            new UpdateServerGroupServersAttributeRequest({
                serverGroupId: serverGroupId,
                servers: [updateServer],
            });
        await this.updateServerGroupServersAttribute(
            updateServerGroupServersAttributeRequest
        );
    }
    ...
    async getServerGroup(
        serverGroupId: string
    ): Promise<ListServerGroupsResponseBodyServerGroups | undefined> {
        const serverGroupsRequest = new ListServerGroupsRequest({
            serverGroupIds: [serverGroupId],
        });
        const serverGroupsResponse: ListServerGroupsResponse =
            await this.listServerGroups(serverGroupsRequest);
